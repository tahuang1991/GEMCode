...
//    std::cout<< " initialize SimTrackMatcherManager "<< std::endl;  
   ...
   // bool has_tftracks(etrk_[0].has_tfTrack>0 && !etrk_[0].allstubs_matched_TF && etrk_[0].nstubs>2);
    ...
    //bool Debug (has_tftracks && etrk_[0].pt-etrk_[0].trackpt>0.5*etrk_[0].pt &&!(phi_diff_ME1 && phi_diff_ME2 && phi_diff_ME3));
    //if (matchprint_ and has_tftracks) printout(match, trk_no, " To debug inefficiency in matching stubs in TFTracks to simtrack");
