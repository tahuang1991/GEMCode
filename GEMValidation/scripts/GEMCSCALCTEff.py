...
e4 = getEff("PU140_200k_Pt2-50_2023_correction_GEMCSC.root",treename,den,num)
...
c1.SaveAs("ALCT_200k_ME41_reco_eff_Positive_PU140.pdf")
c1.SaveAs("ALCT_200k_ME41_reco_eff_Positive_PU140.png")
