...
b1.GetYaxis().SetTitle("Anode Digi Eff")
b1.GetXaxis().SetTitle("#eta of simulated muon track")
b1.SetTitle("Anode Digi Eff in ME31"+" "*10 + "CMS Simulation Preliminary")
b1.SetStats(0)
...
c1.SaveAs("AnodeDigi_100k_ME31_reco_eff_PU0.pdf")
c1.SaveAs("AnodeDigi_100k_ME31_reco_eff_PU0.png")
