...
b1.SetTitle("CLCT Reco in ME41(Negative Endcap)"+" "*10 + "CMS Simulation Preliminary")
b1.SetStats(0)
...
#e3 = getEff("100k_Ana_PU140_UpgradeME41ME41.root",treename,den,num)
...
legend.AddEntry(e4,"requirement to build CLCT >= 3 hits","l")
#legend.AddEntry(e3,"requirement to build CLCT >= 3 hits","l")
...
c1.SaveAs("CLCT_100k_ME41_reco_eff_Negative_new_PU140.pdf")
c1.SaveAs("CLCT_100k_ME41_reco_eff_Negative_new_PU140.png")
