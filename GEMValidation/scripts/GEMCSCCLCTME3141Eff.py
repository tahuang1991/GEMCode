...
b1.SetTitle(" "*10+"CLCT Reco in ME41"+" "*34 + "CMS Simulation Preliminary")
b1.SetStats(0)
...
e3 = getEff("100k_Ana_PU0_UpgradeME11ME21.root",treename,den,num)
...
legend.AddEntry(e4,"requirement to build CLCT >= 4 hits","l")
...
c1.SaveAs("CLCT_100k_ME41_reco_eff_PU0.pdf")
c1.SaveAs("CLCT_100k_ME41_reco_eff_PU0.png")
