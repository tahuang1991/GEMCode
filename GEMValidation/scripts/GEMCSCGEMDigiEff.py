...
b1.GetYaxis().SetRangeUser(0.00,0.20)
b1.GetYaxis().SetTitleOffset(1.0)
b1.GetYaxis().SetNdivisions(520)
b1.GetYaxis().SetTitle("gem overlap possibility")
b1.GetXaxis().SetTitle("#eta of simulated muon track")
b1.SetTitle("GEM Pad Eff in ME21"+" "*10 + "CMS Simulation Preliminary")
b1.SetStats(0)

treename = "GEMCSCAnalyzer/trk_eff_ME21"
den = "has_csc_sh>0 "
num = "has_csc_sh>0 && (has_gem_pad&1)>0 && (has_gem_pad&2)>0"

#e1 = getEff("GEMCSC_Ana_Test1_CSC4.root",treename,den,num)
#e2 = getEff("GEMCSC_Ana_Test1_Wg3.root",treename,den,num)
#e3 = getEff("100k_Ana_PU140_UpgradeME21ME21.root",treename,den,num)
e4 = getEff("PU140_200k_Pt2-50_GE21dphi_GEMCSC.root",treename,den,num)
...
c1.SaveAs("GEMPad_overlap_100k_ME21_reco_eff_PU140.pdf")
c1.SaveAs("GEMPad_overlap_100k_ME21_reco_eff_PU140.png")
