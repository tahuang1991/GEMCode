...
b1.GetYaxis().SetRangeUser(0.0,0.2)
b1.GetYaxis().SetNdivisions(520)
b1.GetYaxis().SetTitle("overlap possibility")
...
den = "has_csc_sh>0 && pt >10 && has_lct>0"
num = "has_csc_sh>0 && (has_lct&1)>0&& (has_lct&2)>0 && pt>10"
...
#legend.Draw("same")
tex = ROOT.TLatex(0.2,0.6,"PU140, p_{T}^{sim}>10Gev")
tex.SetNDC()
tex.SetTextFont(42)
tex.SetTextSize(0.05)
tex.Draw("same")

c1.SaveAs("LCT_100k_ME11_reco_eff_overlap_PU140.pdf")
c1.SaveAs("LCT_100k_ME11_reco_eff_overlap_PU140.png")
