...
b1.SetTitle("LCT Reco in ME31"+" "*10 + "CMS Simulation Preliminary")
b1.SetStats(0)
...
e3 = getEff("PU140_200k_Pt2-50_2023_switchonPosiive_GEMCSC.root",treename,den,num)
...
legend.SetHeader("PU140, with p_{T}^{sim}>10, Negative endcap")
...
#legend.AddEntry(e4,"CSC only Algorithm","l")
#legend.AddEntry(e3,"GEM-CSC Algorithm in ME31","l")
...
c1.SaveAs("LCT_200k_ME31_reco_eff_N_PU140.pdf")
c1.SaveAs("LCT_200k_ME31_reco_eff_N_PU140.png")
