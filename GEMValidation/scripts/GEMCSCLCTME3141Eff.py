...
b1.SetTitle("LCT Reco in ME41"+" "*10 + "CMS Simulation Preliminary")
b1.SetStats(0)
...
#legend.AddEntry(e3,"GEM-CSC Algorithm in ME41","l")
...
c1.SaveAs("LCT_100k_ME41_reco_eff_PU0.pdf")
c1.SaveAs("LCT_100k_ME41_reco_eff_PU0.png")
