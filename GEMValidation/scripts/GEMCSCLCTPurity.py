...
def getPurity(file,dir,den,num,xaxis,h_bins):
    ...
    b1.SetTitle("LCT reco in ME11"+" "*16 + "CMS Simulation Preliminary")
    b1.SetStats(0)
...
#legend.SetFillColor(ROOT.kWhite)
    legend.SetHeader("PU140,simPt > 10Gev,dphi = -99")
#legend.AddEntry(e1,"","l")
#legend.Draw("same")
    tex = ROOT.TLatex(0.30,0.50,"PU140, p_{T}^{sim} > 10Gev")
    tex.SetTextSize(0.05)
    tex.SetNDC()
    tex.Draw("same")
	
    c1.SaveAs("LCT_reco_ME11_%s_Pt10_GE21dphi_v3_PU140.pdf"%xaxis)
    c1.SaveAs("LCT_reco_ME11_%s_Pt10_GE21dphi_v3_PU140.png"%xaxis)
...
def draw2D(file,dir,num,xaxis,yaxis,x_bins,y_bins):
    ...
    b1.SetTitle("LCT reco in ME11, PU140"+" "*16 + "CMS Simulation Preliminary")
    b1.SetStats(0)
...
# legend.Draw("same")
    ...
    c1.SaveAs("LCT_reco_ME11_%s"%xaxis+"_VS_%s_pt10-50_even_PU140.pdf"%yaxis)
    c1.SaveAs("LCT_reco_ME11_%s"%xaxis+"_VS_%s_pt10-50_even_PU140.png"%yaxis)
...
if __name__ == "__main__":
    ...
    file = "PU140_10k_Pt20_test_GEMCSC.root"
    file = "PU140_200k_Pt2-50_2023_fixdphi_GEMCSC.root"
    file = "PU140_200k_Pt2-50_2023_GE21dphi_v3_GEMCSC.root"
    dir = "GEMCSCAnalyzer/LCTTree"
    den = "station==1 && (ring==1||ring==4) && pt>10 && match>0 && has_gemrpc>0"
    num = "station==1 && (ring==1||ring==4) && pt>10 && match>0 && has_gemrpc>0 && passdphicut>0 "
    ...
    xaxis = "hs"
    yaxis = "dphi"
    cut1 = "pt>10 && station==1 && match>0 && (chamber%2)==0"
#    draw2D(file,dir,cut1,xaxis2,yaxis,Eta_bins,DPhi_bins)
