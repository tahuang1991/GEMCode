...
b1.GetYaxis().SetTitle("RPC Digi Eff")
b1.GetXaxis().SetTitle("#eta of simulated muon track")
b1.SetTitle("RPC Digi Eff in ME41"+" "*10 + "CMS Simulation Preliminary")
b1.SetStats(0)

treename = "GEMCSCAnalyzer/trk_eff_ME41"
den = "has_csc_sh>0 && has_rpc_sh>0"
num = "has_csc_sh>0 && has_rpc_dg>0"
...
e4 = getEff("TestRPC_PU140_100k_2023_fixeven_GEMCSCAna.root",treename,den,num)
...
c1.SaveAs("RPCDigi_100k_ME41_reco_eff_new_PU140.pdf")
c1.SaveAs("RPCDigi_100k_ME41_reco_eff_new_PU140.png")
