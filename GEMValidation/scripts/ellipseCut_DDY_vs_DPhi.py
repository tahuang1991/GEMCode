...
def loopEllipse(filedir, treename,fraction, astart, bstart, xaxis, yaxis,x_bins, y_bins,xtitle, ytitle,st_title, etamin, etamax, cuts,text,picname):
    ...
    b0.SetStats(1)
    chain.Draw(todrawb0,cuts[0]+checkvalue,"colz")#background
    print "background todraw ",todrawb0, " cuts ", cuts[0]+checkvalue 
    ...
    #b1.SetMaximum(30)
    b1.SetStats(1)
    chain1.Draw(todrawb1,cuts[1]+checkvalue,"colz")#signal
    print "signal todraw ",todrawb1, " cuts ", cuts[1]+checkvalue 
