...
: 
 //genMuons_(t, v, ps, ev, es)
  simhits_(t, v, ps, ev, es, 
           simVertexInput_, simTrackInput_, 
  ...
  , csc_stubs_(simhits_, csc_digis_, gem_digis_, rpc_digis_, clctInputs_, alctInputs_, lctInputs_, mplctInputs_)
  , csc_rechits_(simhits_, cscRecHit2DInput_, cscSegmentInput_)
  , dt_digis_(simhits_, dtDigiInput_)
  , dt_stubs_(simhits_, dtStubInput_)
  , dt_rechits_(simhits_, dtRecHit1DPairInput_, dtRecSegment2DInput_, dtRecSegment4DInput_)
  //, l1_tracks_(csc_stubs_, dt_digis_, rpc_digis_)
  , l1_tf_tracks_(simhits_, cscTfTrackInputLabel_)
  , l1_tf_cands_(simhits_, cscTfCandInputLabel_, dtTfCandInputLabel_, rpcfTfCandInputLabel_, rpcbTfCandInputLabel_)
  , l1_gmt_cands_(simhits_, gmtRegCandCSCInputLabel_, gmtRegCandDTInputLabel_, 
                  gmtRegCandRPCfInputLabel_, gmtRegCandRPCbInputLabel_, gmtCandInputLabel_, l1ExtraMuonInputLabel_)
  , hlt_tracks_(csc_rechits_, dt_rechits_, rpc_rechits_, gem_rechits_, 
                recoTrackExtraInputLabel_, recoTrackInputLabel_, recoChargedCandidateInputL)
{
