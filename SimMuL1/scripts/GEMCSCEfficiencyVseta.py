...
def cscMatchingEfficiencyToStripsAndWires(filesDir, input_file, plotDir, ext):
    ...
    ## variables for the plot
    topTitle = " " * 11 + "CSC Digi matching Eff" + " " * 35 + "CMS Simulation Preliminary"
    ...
    h1 = draw_geff(t, title, h_bins, toPlot, OR(ok_sh1,ok_sh2), OR(ok_w1,ok_w2), "same", kRed)
...
#    leg.AddEntry(h2, "Strips Digi","l")
    ...
    c.Print("%scsc_wire_digi_matching_efficiency%s"%(plotDir,ext))
...
def cscMatchingEfficiencyToStripsAndWires_2(filesDir, input_file, plotDir, ext):
    ...
    h1 = draw_geff(t, title, h_bins, toPlot, OR(ok_sh1,ok_sh2), OR(ok_st1,ok_st2), "same", kRed)
...
#    leg.AddEntry(h2, "strips Digi","l")
    ...
    c.Print("%scsc_strip_digi_matching_efficiency%s"%(plotDir,ext))
...
#    h2 = draw_geff(t, title, h_bins, toPlot, AND(ok_sh1,ok_st1), ok_clct1, "same")
    h1 = draw_geff(t, title, h_bins, toPlot, ok_sh1, ok_alct1, "same", kRed)
    h2 = draw_geff(t, title, h_bins, toPlot, ok_sh1, ok_clct1, "same")
    ...
    c.Print("%sodd_csc_stub_matching_efficiency%s"%(plotDir,ext))
...
def cscMatchingEfficiencyToAlctClct_2(filesDir, input_file, plotDir, ext):
    ...
    h1 = draw_geff(t, title, h_bins, toPlot, ok_sh2, ok_alct2, "same", kRed)
    h2 = draw_geff(t, title, h_bins, toPlot, ok_sh2, ok_clct2, "same", kBlue)
    ...
    c.Print("%seven_csc_combined_stub_matching_efficiency%s"%(plotDir,ext))
...
def cscMatchingEfficiencyToLct(filesDir, input_file, plotDir, ext):
    ...
    h2 = draw_geff(t, title, h_bins, toPlot, AND(ok_sh1, Pt_15), ok_lct1, "same", kRed)
...
##    h2 = draw_geff(t, title, h_bins, toPlot, AND(ok_sh2, ok_st2, ok_w2, ok_alct2, ok_clct2), ok_lct2, "same", kBlue)
    ...
    leg.AddEntry(h2, "LCT, with Pt>15GeV","l")
    leg.Draw("same");
    ...
    c.Print("%sodd_csc_lct_matching_efficiency%s"%(plotDir,ext))
...
def cscMatchingEfficiencyToLct_2(filesDir, input_file, plotDir, ext):
    ...
    h2 = draw_geff(t, title, h_bins, toPlot, AND(ok_sh2,Pt_15), ok_lct2, "same", kRed)
...
##    h2 = draw_geff(t, title, h_bins, toPlot, AND(ok_sh2, ok_st2, ok_w2, ok_alct2, ok_clct2), ok_lct2, "same", kBlue)
    ...
    leg.SetTextSize(0.04)
    leg.AddEntry(h1, "LCT","l")
    leg.AddEntry(h2, "LCT,with Pt>15","l")
    leg.Draw("same");
    ...
    c.Print("%seven_csc_lct_matching_efficiency%s"%(plotDir,ext))
...
#____________________________________________________________________
def CoPadmatchingtoSimTrWithPtCutEfficiency(filesDir, input_file, plotDir, ext):
    ...
    ## variables for the plot
    topTitle = " " * 11 + "Odd DetId GEM Superchamebr CoPad matching Efficiency" + " " * 20 + "CMS Simulation Preliminary"
    xTitle = "Generated muon #eta"
    yTitle = "Efficiency"
    title = "%s;%s;%s"%(topTitle,xTitle,yTitle)
    toPlot = "TMath::Abs(eta)"
    ...
    Pt_5_15 = TCut("pt>5 && pt<15")
    Pt_15_30 = TCut("pt>15 && pt<30")
    Pt_30_Inf = TCut("pt>30")
    Cut1_den = AND(ok_gsh1,Pt_5_15) 
    Cut1_num = ok_copad1
    Cut2_den = AND(ok_gsh1,Pt_15_30) 
    Cut2_num = ok_copad1
    Cut3_den = AND(ok_gsh1,Pt_30_Inf) 
    Cut3_num = ok_copad1 
    h1 = draw_geff(t, title, h_bins, toPlot, Cut1_den, Cut1_num, "same", kRed, 1, 1)
    h2 = draw_geff(t, title, h_bins, toPlot, Cut2_den, Cut2_num, "same", kBlue, 1, 1)
    h3 = draw_geff(t, title, h_bins, toPlot, Cut3_den, Cut3_num, "same", kGreen)
    ...
    leg = TLegend(0.15,0.80,0.5,0.90, "", "brNDC");
    leg.SetBorderSize(0)
#    leg.SetFillStyle(0)
    leg.SetTextSize(0.04)
    leg.AddEntry(h1, "5<Pt<15","l")
    leg.AddEntry(h2, "15<Pt<30","l")
    leg.AddEntry(h3, "30<Pt","l")
    leg.Draw("same");
    ...
    c.Print("%sodd_gem_copad_matching_WithPtCut_efficiency%s"%(plotDir,ext))

#____________________________________________________________________
def CoPadmatchingtoSimTrWithPtCutEfficiency_2(filesDir, input_file, plotDir, ext):
    ...
    ## variables for the plot
    topTitle = " " * 11 + "Even DetId GEM Superchamebr CoPad matching Efficiency" + " " * 20 + "CMS Simulation Preliminary"
    xTitle = "Generated muon #eta"
    yTitle = "Efficiency"
    title = "%s;%s;%s"%(topTitle,xTitle,yTitle)
    toPlot = "TMath::Abs(eta)"
    ...
    Pt_15_30 = TCut("pt>15 && pt<30")
    Pt_30_Inf = TCut("pt>30")
    Cut1_den = AND(ok_gsh2,Pt_5_15) 
    Cut1_num = ok_copad2
    Cut2_den = AND(ok_gsh2,Pt_15_30) 
    Cut2_num = ok_copad2
    Cut3_den = AND(ok_gsh2,Pt_30_Inf) 
    Cut3_num = ok_copad2 
    h1 = draw_geff(t, title, h_bins, toPlot, Cut1_den, Cut1_num, "same", kRed, 1, 1)
    h2 = draw_geff(t, title, h_bins, toPlot, Cut2_den, Cut2_num, "same", kBlue, 1, 1)
    h3 = draw_geff(t, title, h_bins, toPlot, Cut3_den, Cut3_num, "same", kGreen)
...
#    leg.SetFillStyle(0)
    ...
    c.Print("%seven_gem_copad_matching_WithPtCut_efficiency%s"%(plotDir,ext))
#_______________________________________________________________________________
def makePlots(ext):
...
#    input_file = "gem-csc_stub_ana_pt20_PU100_moreStats.root"
    ...
    CoPadmatchingtoSimTrWithPtCutEfficiency(input_dir, input_file, output_dir, ext)
    CoPadmatchingtoSimTrWithPtCutEfficiency_2(input_dir, input_file, output_dir, ext)
